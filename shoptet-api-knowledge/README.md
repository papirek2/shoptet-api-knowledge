...
git clone https://github.com/YOUR_USERNAME/shoptet-api-knowledge.git .shoptet-api
...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/shoptet-api-knowledge/main/CLAUDE.md \
...
```bash
git submodule add https://github.com/YOUR_USERNAME/shoptet-api-knowledge.git .shoptet-api
```
